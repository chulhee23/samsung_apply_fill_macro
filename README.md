...
## 2021 하반기 채용 사용 가능
사용 시, 
```python run.py data.xlsx```
명령어 입력 후 
바로 크롬에서 삼성 자소서 페이지 내 [이수교과목 탭] -> [과정] 버튼 클릭해서 focus 준 상태로 기다리면
알아서 엑셀 내용이 반영되어 들어간다.

해당 위치에서 tab 키 동작으로 이동하기 때문에 
크롬창에서 마우스 클릭 등 다른 작업이 없어야한다!
